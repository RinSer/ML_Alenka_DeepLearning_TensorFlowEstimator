...
namespace TranferLearningTF
{
    ...
    {
        static readonly string _assetsPath = Path.Combine(Environment.CurrentDirectory, "../../../assetss");
        ...
        public static void TrainAndPredict(Func<IEnumerable<ImagePrediction>, bool> displayResults)
        {
